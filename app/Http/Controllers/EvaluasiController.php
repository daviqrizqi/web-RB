...
class EvaluasiController extends Controller
{
    ...
    public function getEvaluasi($user_id){
        ...
        try {
            ...
            $data =  Permasalahan::with(['rencanaAksi.targetPenyelesaian', 'rencanaAksi.realisasiPenyelesaian', 'rencanaAksi.targetAnggaran', 'rencanaAksi.realisasiAnggaran','rencanaAksi.reject'])
    ...
    public function updateEvaluasi(Request $request, $user_id){
        ...
        $request->validate([
            ...
            'realisasi_anggaran.jumlah' => 'required',
